...
N <- 3000 # 50 training observations
...
for(alpha in 1:length(alphas))
{
  for(trial in 1:num_of_trials)
  {
    ...
    for(i in 1:N)
    {
      ...
      else if(labels.generated[i] == 5)
        generated_data[i,] <- mvrnorm(1,(1/sqrt(dimensions))*rep(2.5,dimensions),diag(dimensions))
      else if(labels.generated[i] == 6)
        generated_data[i,] <- mvrnorm(1,(1/sqrt(dimensions))*rep(3,dimensions),diag(dimensions))
      else if(labels.generated[i] == 7)
        generated_data[i,] <- mvrnorm(1,(1/sqrt(dimensions))*rep(3.5,dimensions),diag(dimensions))
      else if(labels.generated[i] == 8)
        generated_data[i,] <- mvrnorm(1,(1/sqrt(dimensions))*rep(4,dimensions),diag(dimensions))
      else if(labels.generated[i] == 9)
        generated_data[i,] <- mvrnorm(1,(1/sqrt(dimensions))*rep(4.5,dimensions),diag(dimensions))
      else
        generated_data[i,] <- mvrnorm(1,(1/sqrt(dimensions))*rep(5,dimensions),diag(dimensions))
    }
...
average_cvg_aps <- c(0.9864932466233116,
                     0.943471735867934,
                     0.9029514757378688,
                     0.8629314657328664,
                     0.8054027013506755)
avg_set_size_aps <- c(6.76088044022011,
                      5.697348674337169,
                      4.972986493246624,
                      4.486243121560781,
                      3.9979989994997505)
